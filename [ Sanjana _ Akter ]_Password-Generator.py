...
root = Tk()
root.title("Sanjana Akter Password Generator .")
root.geometry("400x300")

# Input: Password length
Label(root, text="Here you provide your Password Length:", font=("Helvetica", 10)).pack(pady=5)
...
Label(root, text="Include your password length here:", font=("Helvetica", 10)).pack(pady=5)
...
# Generate button
Button(root, text="The Computer will automatically Generate the Password ", command=generate_password, bg="lightpink").pack(pady=10)

# Output display (copyable)
Label(root, text="Generated a strong Password that no one can guess:", font=("Helvetica", 10)).pack(pady=5)
